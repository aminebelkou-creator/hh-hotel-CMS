...
| Fix later | 10 | 1 | Small product gaps noticed in use, in a table at the end; started 25 Sep: legal set, offers on home, contact in header, Book button on phones, gallery and lighter photos, blog, guest reviews, publish guard and verification retry done the same day |
| **Total** | **58** | **69** | |
