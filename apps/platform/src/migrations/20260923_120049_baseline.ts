...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('super-admin', 'owner', 'editor');
  CREATE TYPE "public"."enum_tenants_plan" AS ENUM('concierge', 'starter', 'managed', 'dedicated');
  CREATE TYPE "public"."enum_sites_enabled_locales" AS ENUM('en', 'fr', 'de', 'es', 'it');
  CREATE TYPE "public"."enum_sites_default_locale" AS ENUM('en', 'fr', 'de', 'es', 'it');
  CREATE TYPE "public"."enum_sites_status" AS ENUM('draft', 'live', 'suspended');
  CREATE TYPE "public"."enum_pages_blocks_hero_provenance_origin" AS ENUM('generated', 'human', 'locked');
  CREATE TYPE "public"."enum_pages_blocks_rich_text_provenance_origin" AS ENUM('generated', 'human', 'locked');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_provenance_origin" AS ENUM('generated', 'human', 'locked');
  CREATE TYPE "public"."enum__pages_v_blocks_rich_text_provenance_origin" AS ENUM('generated', 'human', 'locked');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('en', 'fr');
  CREATE TYPE "public"."enum_media_rights" AS ENUM('owned', 'licensed', 'unknown');
  CREATE TYPE "public"."enum_domains_status" AS ENUM('pending', 'verified', 'active', 'error');
  CREATE TYPE "public"."enum_domains_certificate" AS ENUM('none', 'requested', 'issued', 'expiring', 'error');
  ...
  CREATE TABLE "tenants" (
  	...
  	"plan" "enum_tenants_plan" DEFAULT 'concierge',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "sites" (
  	...
  	"name" varchar NOT NULL,
  	"slug" varchar NOT NULL,
  	"default_locale" "enum_sites_default_locale" DEFAULT 'en',
  	"theme" jsonb,
  ...
  CREATE TABLE "pages_blocks_hero" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer,
  	"provenance_origin" "enum_pages_blocks_hero_provenance_origin" DEFAULT 'human',
  ...
  CREATE TABLE "pages_blocks_rich_text" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"provenance_origin" "enum_pages_blocks_rich_text_provenance_origin" DEFAULT 'human',
  	"provenance_source_fact" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_hero" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  	"provenance_origin" "enum__pages_v_blocks_hero_provenance_origin" DEFAULT 'human',
  	"provenance_source_fact" varchar,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_rich_text" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"provenance_origin" "enum__pages_v_blocks_rich_text_provenance_origin" DEFAULT 'human',
  	"provenance_source_fact" varchar,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "media" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"tenant_id" integer,
  	"rights" "enum_media_rights" DEFAULT 'unknown',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "domains" (
  	...
  	"certificate" "enum_domains_certificate" DEFAULT 'none',
  	"provider" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "releases" (
  	...
  	"status" "enum_releases_status" DEFAULT 'built',
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"sites_find" boolean DEFAULT false,
  	"sites_update" boolean DEFAULT false,
  ...
  ALTER TABLE "releases" ADD CONSTRAINT "releases_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "releases" ADD CONSTRAINT "releases_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "releases_tenant_idx" ON "releases" USING btree ("tenant_id");
  CREATE INDEX "releases_site_idx" ON "releases" USING btree ("site_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_hero_provenance_origin";
  DROP TYPE "public"."enum_pages_blocks_rich_text_provenance_origin";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_blocks_hero_provenance_origin";
  DROP TYPE "public"."enum__pages_v_blocks_rich_text_provenance_origin";
  DROP TYPE "public"."enum__pages_v_version_status";
  DROP TYPE "public"."enum__pages_v_published_locale";
  DROP TYPE "public"."enum_media_rights";
  DROP TYPE "public"."enum_domains_status";
  DROP TYPE "public"."enum_domains_certificate";
