...
const home: PageInput = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        { title: { fr: 'Réception 24h/24', en: '24-hour reception' }, text: { fr: 'Idéal pour les arrivées tardives, avec une équipe multilingue.', en: 'Ideal for late arrivals, with a multilingual team.' } },
        { title: { fr: 'Self check-in', en: 'Self check-in' }, text: { fr: 'Enregistrez-vous à la borne ou sur votre téléphone, sans attente.', en: 'Check in at the kiosk or on your phone, with no queue.' } },
        { title: { fr: 'Petit-déjeuner buffet', en: 'Breakfast buffet' }, text: { fr: 'Un buffet « à la française », avec des produits locaux et bio.', en: 'A French-style buffet with local and organic produce.' } },
        { title: { fr: 'Tablette en chambre', en: 'In-room tablet' }, text: { fr: 'Réception, services et bonnes adresses, depuis votre lit.', en: 'Reception, services and local tips, from your bed.' } },
        { title: { fr: 'Wi-Fi très haut débit', en: 'High-speed Wi-Fi' }, text: { fr: 'Gratuit et illimité dans tout l’hôtel.', en: 'Free and unlimited throughout the hotel.' } },
        { title: { fr: 'Animaux bienvenus', en: 'Pets welcome' }, text: { fr: 'Chiens et chats acceptés.', en: 'Dogs and cats accepted.' } },
      ],
    },
    {
      blockType: 'gallery',
...
const services: PageInput = {
  ...
  blocks: [
    ...
    },
    {
      ...
      items: [
        { title: { fr: 'Réception 24h/24', en: '24-hour reception' } },
        { title: { fr: 'Wi-Fi gratuit et illimité', en: 'Free unlimited Wi-Fi' }, text: { fr: 'Très haut débit, et prise Ethernet en chambre.', en: 'High speed, plus an Ethernet socket in the room.' } },
        { title: { fr: 'Ascenseur', en: 'Lift' }, text: { fr: 'Accessible aux personnes à mobilité réduite.', en: 'Accessible to guests with reduced mobility.' } },
        { title: { fr: 'Climatisation', en: 'Air conditioning' } },
        { title: { fr: 'Animaux acceptés', en: 'Pets accepted' }, text: { fr: 'Chiens et chats, avec supplément.', en: 'Dogs and cats, for a supplement.' } },
        { title: { fr: 'Consigne à bagages gratuite', en: 'Free luggage storage' } },
